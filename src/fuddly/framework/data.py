...
class DataBackend(object):
    ...
    def show(self, raw_limit=200, log_func=sys.stdout.write, verbose=Verbose.Normal, debug=False):
        raise NotImplementedError
...
class NodeBackend(DataBackend):
    ...
    def show(self, raw_limit=200, log_func=sys.stdout.write, verbose=Verbose.Normal, debug=False):
        self._node.show(raw_limit=raw_limit, log_func=log_func, debug=debug, verbose=verbose)
...
class Data(object):
    ...
    def show(self, raw_limit=200, log_func=sys.stdout.write, verbose=Verbose.Normal, debug=False):
        self._backend.show(raw_limit=raw_limit, log_func=log_func, verbose=verbose, debug=debug)
