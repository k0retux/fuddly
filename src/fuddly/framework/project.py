...
class Project(object):
    ...
    def __init__(self, enable_fbk_processing=True,
        ...
        self.project_scenarios_from_bricks = None
        self.project_scenario_bricks = None
    ...
    def register_scenario_bricks(self, *scenario_bricks):
        if self.project_scenario_bricks is None:
            self.project_scenario_bricks = []
        self.project_scenario_bricks += scenario_bricks
